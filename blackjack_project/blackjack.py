...
#  You might need to look up append() and remove().
    ...
    # if 11 in cards and score >21 and len(cards)==2:
...
def blackjack():
    ...
    while not game_over:
        ...
        print(f"ur cards={user_cards},user_sum={user_score}")
        print(f"computer first cards :{computer_cards[0]} ")
        if user_score ==0 or computer_score==0 or user_score>21:
            game_over=True
        else:
            option=input("do you want to pick another card , then type y : ").lower()
            if option=="y":
    ...
    while computer_score!=0 and computer_score<17:
        ...
        computer_score=calculate_score(computer_cards)
    print(f"your cards are {user_cards} and ur score is {user_score}")
    print(f"computers cards are {computer_cards} and computers score is {computer_score} ")
    print(compare(user_score,computer_score))
while input("\nDo u want to play blackjack  , then press y : ")=="y" or "Y" :
    blackjack()
...
#Hint 12: Once the user is done, it's time to let the computer play. The computer should keep drawing cards as long as it has 
...
#Hint 14: Ask the user if they want to restart the game. If they answer yes, clear the console and start a new game of blackjack and
